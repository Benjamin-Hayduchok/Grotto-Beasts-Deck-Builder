      ...
      <form className="formGroup" onSubmit={submitSearch}>
        <div className="formRow">
          <div className="inputGroup">
            <label className="cardSearchLabel" htmlFor="cardName">
              Name
            </label>
            <input
        ...
        <div className="formRow">
          <div className="inputGroup">
            <label className="cardSearchLabel" htmlFor="cardType">
              Type
            </label>
            <input
              ...
              type="text"
              id="cardType"
              placeholder="Enter to search by type"
            ></input>
            <label className="cardSearchLabel" htmlFor="cardEpic">
              Epic?
            </label>
        ...
        <div className="formRow">
          <div className="inputGroup">
            <label className="cardSearchLabel" htmlFor="cardPower">
              🛡️
            </label>
            <input
              className="cardPowerInput"
              type="text"
              id="cardPower"
              placeholder="Search by Power"
            ></input>
            <label className="cardSearchLabel" htmlFor="cardGoal">
              ❤️
            </label>
            <input
              className="cardGoalInput"
              type="text"
              id="cardGoal"
              placeholder="Search by Goal Amount"
            ></input>
            <label className="cardSearchLabel" htmlFor="cardCost">
              🌟
            </label>
            <input
              className="cardCostInput"
              type="text"
              id="cardCost"
        ...
        <div className="formRow">
          <div className="inputGroup">
            <label className="cardSearchLabel" htmlFor="cardEffect">
              Effect
            </label>
            <input
              className="cardEffectInput"
              type="text"
              id="cardEffect"
